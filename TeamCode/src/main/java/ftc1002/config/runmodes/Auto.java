...
import static ftc1002.config.util.FieldConstants.*;
...
public class Auto {
    ...
    public boolean actionBusy, liftPIDF = true, pivotPIDF = true;
    ...
    public Auto(HardwareMap hardwareMap, Telemetry telemetry, Follower follower, boolean isBlue, boolean isBucket) {
        // TODO: Add assignments for subsystems
