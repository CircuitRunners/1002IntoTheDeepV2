...
import ftc1002.pedroPathing.localization.GoBildaPinpointDriver;
...
public class PinpointLocalizer extends Localizer {
    ...
    public PinpointLocalizer(HardwareMap map, Pose setStartPose){
        ...
        setOffsets(2.71126772, 6.03262717, DistanceUnit.INCH); //these are tuned for 3110-0002-0001 Product Insight #1
